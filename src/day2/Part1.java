...
public class Part1 {
	...
	public static void main(String[] args) {
		String[] array = { "forward 3", "down 6", "forward 7", "down 4", "down 8", "down 6", "down 4", "down 6",
...
//		String[] array = { "forward 5", "down 5", "forward 8", "up 3", "down 8", "forward 2" }; /*= 150*/
		int posHori = 0, posVert = 0, total;

		for (int i = 0; i < array.length; i++) {
			String[] a = array[i].split(" ");
			switch (a[0]) {
			case "up":
				posVert -= Integer.parseInt(a[1]);
				break;
			...
			case "forward":
				posHori += Integer.parseInt(a[1]);
				break;
			}
		}
		total = posHori * posVert;
